			...
			<DialogContent className="max-w-md bg-gray-a1 backdrop-blur-xl border-gray-a5">
				...
				<div className="space-y-4 py-4">
					<div className="text-center">
						...
						<div className="rounded-lg border border-gray-a4 bg-gray-a2 p-4 mb-4">
							<div className="flex items-center justify-between mb-3">
								<span className="text-5 font-semibold text-gray-12">Monthly Subscription</span>
								<span className="text-5 font-bold text-gray-12">
									{formatPrice(price, currency)}
									<span className="text-3 text-gray-11 font-normal">/month</span>
								</span>
							</div>
							<ul className="space-y-2 text-left">
								<li className="flex items-start gap-2">
									<svg className="h-4 w-4 text-green-11 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
									</svg>
									<span className="text-3 text-gray-12">Unlimited books</span>
								</li>
								<li className="flex items-start gap-2">
									<svg className="h-4 w-4 text-green-11 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
									</svg>
									<span className="text-3 text-gray-12">Cancel anytime</span>
								</li>
								<li className="flex items-start gap-2">
									<svg className="h-4 w-4 text-green-11 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
										<path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
									</svg>
									<span className="text-3 text-gray-12">All premium features</span>
								</li>
							</ul>
						</div>
					</div>
