					...
					<DialogContent className="max-w-sm w-[calc(100vw-2rem)] sm:w-[90vw] bg-white/90 dark:bg-gray-a1/50 backdrop-blur-xl border-gray-a4 dark:border-gray-a5 p-4 sm:p-6 [&>button.absolute]:hidden">
						<DialogHeader className="relative pb-2">
							...
							<button
								...
								className="absolute right-0 top-0 rounded-sm transition-all hover:bg-gray-a2 dark:hover:bg-gray-a3 focus:outline-none focus:ring-2 focus:ring-gray-a8 focus:ring-offset-2 p-1.5 text-gray-12 dark:text-gray-12 hover:text-gray-12 shrink-0 z-10"
								aria-label="Close"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
						...
						<div className="space-y-4 py-2">
							<p className="text-3 sm:text-4 text-gray-12 dark:text-gray-11">
							...
							<div className="flex gap-2 sm:gap-3 pt-2">
								<Button
									...
									onClick={() => setBookToDelete(null)}
									disabled={isPending}
									className="flex-1 px-3 sm:px-4 py-2 text-sm sm:text-base bg-gray-a1 dark:bg-gray-a2/80 backdrop-blur-sm border border-gray-a4 hover:bg-gray-a2 dark:hover:bg-gray-a3/80 text-gray-12 dark:text-gray-12"
								>
									Cancel
								</Button>
								<Button
