...
const Flipbook = memo(
  ({ viewerStates, setViewerStates, flipbookRef, pdfDetails }) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative h-[15rem] xs:h-[20rem] lg:h-[28rem] xl:h-[30rem] w-full bg-transparent flex justify-center items-center overflow-hidden flex-1 min-h-0",
